...
#include "app_wMBus.h"
#include "app_conf.h"
[#if (S_Phy_Meter?? && S_Phy_Meter == "true") || (S_Phy_Concentrator?? && S_Phy_Concentrator == "true") || (S_Phy_Meter_Button?? && S_Phy_Meter_Button == "true") || (S_Phy_Meter_RadioTimer?? && S_Phy_Meter_RadioTimer == "true")]
...
[#if HALCompliant??]
[#list voids as void]
  [#if (FamilyName=="STM32WBA" && void.genCode?? && void.genCode || FamilyName!="STM32WBA") && (void.isStatic?? && !void.isStatic) && ((void.bspUsed?? && void.bspUsed && !void.isNotGenerated)||(void.functionName!="SystemClock_Config"))]
...
[#list voids as void]
[#list ips as ip]
[#if FamilyName=="STM32WL" && ip?contains("LoRaWAN") && void.functionName?contains("RTC")]
